                      ...
                      {group.items.map((skill, i) => {
                        ...
                        return (
                          <motion.div 
                            ...
                            key={i} 
                            className="flex items-start gap-4 p-5 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors shadow-sm"
                          >
                            <div className="p-2 bg-indigo-500/20 text-indigo-400 rounded-lg flex-shrink-0">
                               {iconMap[skill]}
                            </div>
                            <div>
                              <h4 className="text-slate-200 font-bold text-[15px]">{category}</h4>
                              {desc && <p className="text-slate-400 text-sm mt-2 leading-relaxed">{desc}</p>}
                            </div>
                          </motion.div>
                        );
                      })}
